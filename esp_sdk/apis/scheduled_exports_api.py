...
class ScheduledExportsApi(object):
    ...
    def activate_export(self, scheduled_export_id, **kwargs):
        ...
        :param str include: Related objects that can be included in the response:  external_account, creator, user See Including Objects for more information.
    ...
    def create(self, authenticated, external_account_id, hour, time_zone, type, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create(authenticated, external_account_id, hour, time_zone, type, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param bool authenticated: Whether or not require authentication before viewing the file. Valid values are true, false (required)
        :param int external_account_id: The id of the external account the report will be exported for (required)
        ...
        :param str type: Type of export to control frequency. Valid values are weekly, daily, monthly (required)
        :param str include: Related objects that can be included in the response:  external_account, creator, user See Including Objects for more information.
        ...
        :param str recipient: Email address the export will be sent to if unauthenticated
        :param bool send_with_attachment: Whether or not to send the file as an attachment. Valid values are true, false
        :param int user_id: The id of the user the report will be emailed to when authenticated is selected
        :return: ScheduledExport
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_with_http_info(authenticated, external_account_id, hour, time_zone, type, **kwargs)
        else:
            (data) = self.create_with_http_info(authenticated, external_account_id, hour, time_zone, type, **kwargs)
            return data

    def create_with_http_info(self, authenticated, external_account_id, hour, time_zone, type, **kwargs):
        """
        Create a(n) Scheduled Export
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_with_http_info(authenticated, external_account_id, hour, time_zone, type, callback=callback_function)
        ...
        all_params = ['authenticated', 'external_account_id', 'hour', 'time_zone', 'type', 'include', 'day', 'filter', 'recipient', 'send_with_attachment', 'user_id']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('authenticated' not in params) or (params['authenticated'] is None):
            raise ValueError("Missing the required parameter `authenticated` when calling `create`")
        ...
        form_params = []
        local_var_files = {}
        if 'authenticated' in params:
            form_params.append(('authenticated', params['authenticated']))
        if 'day' in params:
        ...
        if 'recipient' in params:
            form_params.append(('recipient', params['recipient']))
        if 'send_with_attachment' in params:
            form_params.append(('send_with_attachment', params['send_with_attachment']))
    ...
    def unsubscribe_export(self, uuid, **kwargs):
        """
        Update a(n) Scheduled Export
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.unsubscribe_export(uuid, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.unsubscribe_export_with_http_info(uuid, **kwargs)
        else:
            (data) = self.unsubscribe_export_with_http_info(uuid, **kwargs)
            return data

    def unsubscribe_export_with_http_info(self, uuid, **kwargs):
        """
        Update a(n) Scheduled Export
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.unsubscribe_export_with_http_info(uuid, callback=callback_function)
    ...
    def update_with_http_info(self, id, **kwargs):
        ...
        all_params = ['id', 'include', 'day', 'filter', 'hour', 'send_with_attachment', 'time_zone']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
